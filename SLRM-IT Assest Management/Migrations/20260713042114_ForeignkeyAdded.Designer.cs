...
namespace SLRM_IT_Assest_Management.Migrations
{
    ...
    [Migration("20260713042114_ForeignkeyAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SLRM_IT_Assest_Management.Models.ItemCodeMaster", b =>
                {
                    b.Property<int>("ItemCodeMasterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ItemCodeMasterId"));
            ...
            modelBuilder.Entity("SLRM_IT_Assest_Management.Models.ItemNameMaster", b =>
                {
                    b.Property<int>("ItemNameMasterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ItemNameMasterId"));

                    b.Property<string>("ItemName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("ItemNameMasterId");

                    b.ToTable("ItemNameMasters");
                });
            ...
            modelBuilder.Entity("SLRM_IT_Assest_Management.Models.StockInventory", b =>
                {
                    ...
                    b.Property<string>("RequesitionNo")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SLRM_IT_Assest_Management.Models.StockIssue", b =>
                {
                    ...
                    b.Property<string>("Level1Remarks")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Level1Status")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("Level2Remarks")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Level2Status")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("SLRM_IT_Assest_Management.Models.StockInventory", b =>
                {
                    b.HasOne("SLRM_IT_Assest_Management.Models.ItemCodeMaster", "ItemCodeMaster")
                        .WithMany()
                        .HasForeignKey("ItemCodeMasterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SLRM_IT_Assest_Management.Models.StockIssue", b =>
                {
                    ...
                    b.HasOne("SLRM_IT_Assest_Management.Models.StockInventory", "StockInventory")
                        .WithMany()
